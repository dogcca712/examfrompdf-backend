...
\usepackage{tabularx} % ★ 新增：用于让题干换行但分数固定在右侧
...
\newcommand{\ExamMeta}[1]{%
\vspace{-0.3em}
\noindent\textbf{Course:} #1\\
...
\newcommand{\MCQ}[7]{%
\QBlockStart{10}
% 用 tabularx：左边 X 列自动换行，右边 r 列固定显示分数
\noindent\begin{tabularx}{\textwidth}{@{}Xr@{}}
\textbf{Q#1.} #2 & \textbf{[#7~marks]}
\end{tabularx}\\
